...
export class IncidenciaService {
  ...
  actualizarEstado(id: number, nuevoEstado: string): Observable<Incidencia> {
    // Apuntamos a la ruta exacta que pide el Swagger: /api/incidencias/{id}/estado
    // Pasamos el nuevoEstado en el cuerpo de la petición
    return this.http.put<Incidencia>(`${this.apiUrl}/${id}/estado`, nuevoEstado);
  }
}